...
public class ViewUserLogin {
	...
	private ViewUserLogin() {
		...
		// Establish the text input operand field for the OTP
		// Establish the text input field for the OTP
		setupTextUI(text_OTP, "Arial", 18, 300, Pos.BASELINE_LEFT, 50, 260, true);
		text_OTP.setPromptText("Enter One Time Password");
