...
public class ViewAdminHome {
	...
	*/
	...
	protected static Button button_DiscussionSystem = new Button("Discussion System");
	protected static Alert alertNotImplemented = new Alert(AlertType.INFORMATION);
	protected static Alert listAllUsers = new Alert(AlertType.INFORMATION);
	// This is a separator and it is used to partition the GUI for various tasks
	...
	*/
	...
	private ViewAdminHome() {
		...
		setupButtonUI(button_DiscussionSystem, "Dialog", 16, 250, Pos.CENTER, 290, 470);
		button_DiscussionSystem.setOnAction((event) -> {ControllerAdminHome.performDiscussionSystem(); });
